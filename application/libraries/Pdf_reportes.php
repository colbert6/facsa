...
class Pdf_reportes extends TCPDF
{
    ...
    public function Header() {        
        ...
        $this->SetAuthor('FACSA - Colbert Calampa Tantachuco');
        $this->SetSubject('Reporte FACSA');
        $this->SetKeywords('Reporte, FACSA');
        ...
        switch ($this->motivo) {
            case 'reporte':
                $text="<strong> Reporte Generado </strong><br>";
                $text.=" Fecha :: {$this->fecha_creacion}<br>" ;
                $text.=" Usuario :: {$this->usuario_generador} " ;
                break;
